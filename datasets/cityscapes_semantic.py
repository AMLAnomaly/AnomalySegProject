...
class CityscapesSemantic(LightningDataModule):
    def __init__(
        ...
        self.transforms = Transforms(
            ...
            oe_road_only=oe_road_only,
            oe_perspective_scale=oe_perspective_scale,
        )
        self.ood_val_path = ood_val_path
    ...
    def setup(self, stage: Union[str, None] = None) -> LightningDataModule:
        ...
        if self.ood_val_path:
             self.road_anomaly_dataset = RoadAnomaly(
                 root=self.ood_val_path,
                 transform=T.ToImage()
             )
    ...
    def val_dataloader(self):
        ...
        if self.ood_val_path and hasattr(self, 'road_anomaly_dataset'):
            ood_loader = DataLoader(
                self.road_anomaly_dataset,
                collate_fn=self.eval_collate,
                **self.dataloader_kwargs
            )
