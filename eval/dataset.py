...
def is_label(filename):
    return (
        filename.endswith("_gtFine_labelIds.png")
        or filename.endswith("_labelTrainIds.png")
    )
...
class cityscapes(Dataset):
    ...
    def __init__(self, root, input_transform=None, target_transform=None, subset='val'):
        ...
        print("Cityscapes subset:", subset)
        print("  #total images =", len(self.filenames))
        print("  #GT found     =", len(self.filenamesGt))
